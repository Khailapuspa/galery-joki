<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 bg-slate-900 fixed-start " id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand d-flex align-items-center m-0"
            ...
            <span class="font-weight-bold text-lg">Azurakip</span>
        </a>
    </div>
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link  {{ is_current_route('dashboard') ? 'active' : '' }}"
                    ...
                    <span class="nav-link-text ms-1">Like</span>
                </a>
            </li>
            ...
            {{-- Sidebar Galery --}}
            <li class="nav-item">
                <a class="nav-link {{ is_current_route('Vgalery.index') ? 'active' : '' }}" href="{{ route('Vgalery.index') }}">
                    <div class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                        <svg width="30px" height="30px" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
                            <title>Gallery Icon</title>
                            <g fill="none" fill-rule="evenodd">
                                <g transform="translate(10, 10)" fill="#4A4A4A">
                                    <rect x="0" y="0" width="28" height="20" rx="3" fill="#ffffff" stroke="#4A4A4A" />
                                    <circle cx="7" cy="7" r="2" fill="#4A4A4A"/> <!-- Sun or moon -->
                                    <path d="M2 18 L12 10 L20 16 L26 12 L26 18 Z" fill="#4A4A4A"/> <!-- Mountain range -->/
                                </g>
                            </g>
                        </svg>
                    </div>
            ...
            {{-- Sidebar Post --}}
            <li class="nav-item">
                <a class="nav-link {{ is_current_route('Vposts.index') ? 'active' : '' }}" href="{{ route('Vposts.index') }}">
                    <div class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                        <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1" xmlns="http://www.w3.org/2000/svg">
                            <g id="gallery-icon" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <rect fill="#FFFFFF" x="12" y="12" width="24" height="24" rx="4"></rect>
                                <rect fill="#FFFFFF" x="4" y="4" width="24" height="24" rx="4" style="opacity:0.6;"></rect>
                                <circle fill="#000000" cx="26" cy="18" r="3"></circle>
                                <path d="M20 28 L28 20 L36 28 L20 28 Z" fill="#000000"></path>
                            </g>
                        </svg>
                    </div>
            ...
            <li class="nav-item mt-2">
                <div class="d-flex align-items-center nav-link">
                    ...
                    <span class="font-weight-normal text-md ms-2">Pengaturan User</span>
                </div>
            </li>
